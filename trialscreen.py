...
class Ui_profilewindow(object):
    ...
    def setupUi(self, profilewindow):
        ...
        self.nameLineEdit_2Profile.setInputMethodHints(QtCore.Qt.ImhNone)
        ...
        self.ExitProfile.clicked.connect(profilewindow.close)
        self.NextProfile.clicked.connect(profilewindow.hide)
        
        self.NextProfile.clicked.connect(self.clickMethod)
        
        self.nameLineEditProfile.textChanged['QString'].connect(self.nameLineEditProfile.setText)
        QtCore.QMetaObject.connectSlotsByName(profilewindow)

    def retranslateUi(self, profilewindow):
        _translate = QtCore.QCoreApplication.translate
        profilewindow.setWindowTitle(_translate("profilewindow", "Form"))
        ...
        self.ageGroupComboBoxProfile.setItemText(0, _translate("profilewindow", "03 - 10"))
        self.ageGroupComboBoxProfile.setItemText(1, _translate("profilewindow", "11- 18"))
        self.ageGroupComboBoxProfile.setItemText(2, _translate("profilewindow", "19 - 30"))
        self.ageGroupComboBoxProfile.setItemText(3, _translate("profilewindow", "31 - 45"))
        self.ageGroupComboBoxProfile.setItemText(4, _translate("profilewindow", "46 - 55"))
        self.ageGroupComboBoxProfile.setItemText(5, _translate("profilewindow", "55 - 75"))
        self.ageGroupComboBoxProfile.setItemText(6, _translate("profilewindow", "75 - 80"))
        self.ageGroupComboBoxProfile.setItemText(7, _translate("profilewindow", "80 or Above"))
        ...
        self.bloodGroupProfileComboBox_2.setItemText(0, _translate("profilewindow", "A+"))
        self.bloodGroupProfileComboBox_2.setItemText(1, _translate("profilewindow", "A-"))
        self.bloodGroupProfileComboBox_2.setItemText(2, _translate("profilewindow", "B+"))
        self.bloodGroupProfileComboBox_2.setItemText(3, _translate("profilewindow", "B-"))
        self.bloodGroupProfileComboBox_2.setItemText(4, _translate("profilewindow", "O+"))
        self.bloodGroupProfileComboBox_2.setItemText(5, _translate("profilewindow", "O-"))
        self.bloodGroupProfileComboBox_2.setItemText(6, _translate("profilewindow", "AB+"))
    ...
    def clickMethod(self):
        print('Your name: ' + self.nameLineEditProfile.text())
